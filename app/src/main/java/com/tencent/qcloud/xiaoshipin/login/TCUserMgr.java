...
//                        mUserId = serviceSig.optString("userID");
                ...
                public void onFailure(int code, final String msg) {
                    ...
                    if (callback != null) {
                        String errorMsg = msg;
                        if (code == 620) {
                            errorMsg = TCApplication.getApplication().getResources().getString(R.string.tc_user_mgr_user_does_not_exist);
                        } else if (code == 621) {
                            errorMsg = TCApplication.getApplication().getResources().getString(R.string.tc_user_mgr_wrong_password);
                        }
